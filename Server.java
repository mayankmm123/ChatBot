...
static DataOutputStream dout;
    ...
    Server(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/1.png"));    // image ko image icon me convert kiya
        ...
        //Frame code
        f.setSize(450,700);
        f.setLocation(200,30);    // screen pe kaha khul rahi hai vo set kar rahe hai
    ...
    public static void main(String[] args) {
        new Server();           // create anonymous object of server class
        try{
